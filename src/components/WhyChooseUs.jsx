    ...
    <section id="why-choose-us" className="py-16 lg:py-[68px] bg-[#F8F9FA] border-b border-gray-200">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-3.5 sm:gap-4 items-start">
          ...
          <div className="md:col-span-2 lg:col-span-5 bg-white border border-gray-200/90 rounded-2xl p-3 sm:p-5 lg:p-5 shadow-2xs hover:border-blue-300/80 hover:shadow-xs transition-all duration-200 flex flex-col group">
            <div>
              {/* Corporate Image */}
              <div className="relative w-full h-36 sm:h-52 lg:h-60 rounded-xl overflow-hidden mb-3.5 sm:mb-4 border border-gray-100 bg-gray-100">
                <img
              ...
              {/* Title & Description */}
              <h3 className="text-[13.5px] sm:text-[16px] font-semibold text-[#111827] tracking-tight group-hover:text-[#1D4ED8] transition-colors leading-snug">
                Business-Focused Approach
              </h3>
              <p className="mt-1.5 text-[11.5px] sm:text-[13.5px] text-[#5B6472] leading-relaxed">
            ...
            <div className="pt-2.5 sm:pt-3.5 mt-2.5 sm:mt-3.5 border-t border-gray-100 flex items-center justify-between text-[10px] sm:text-[12px] font-medium text-[#5B6472]">
              <span className="group-hover:text-[#111827] transition-colors">Outcome-Driven Architecture</span>
              <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-gray-50 border border-gray-200/80 flex items-center justify-center text-gray-400 group-hover:text-[#1D4ED8] group-hover:border-blue-200 group-hover:bg-blue-50/50 transition-all duration-200">
          ...
          {/* RIGHT 4 MEDIUM CARDS: 2x2 Bento Subgrid (Spans 7 cols on lg).
              Two columns from the smallest width — these four stacking to
              four full-width rows on mobile was the main source of extra
              scroll in this section. */}
          <div className="md:col-span-2 lg:col-span-7 grid grid-cols-2 gap-2.5 sm:gap-4">
            
            {/* 02 — Scalable Technology */}
            <div className="bg-white border border-gray-200/90 rounded-2xl p-3 sm:p-5 lg:p-5 shadow-2xs hover:border-blue-300/80 hover:shadow-xs transition-all duration-200 flex flex-col justify-between group">
              <div>
                <div className="flex items-center justify-between mb-2.5 sm:mb-3">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-emerald-50/80 border border-emerald-100 text-emerald-600 flex items-center justify-center shrink-0">
            ...
            <div className="bg-white border border-gray-200/90 rounded-2xl p-3 sm:p-5 lg:p-5 shadow-2xs hover:border-blue-300/80 hover:shadow-xs transition-all duration-200 flex flex-col justify-between group">
              <div>
                <div className="flex items-center justify-between mb-2.5 sm:mb-3">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-amber-50/80 border border-amber-100 text-amber-600 flex items-center justify-center shrink-0">
            ...
            <div className="bg-white border border-gray-200/90 rounded-2xl p-3 sm:p-5 lg:p-5 shadow-2xs hover:border-blue-300/80 hover:shadow-xs transition-all duration-200 flex flex-col justify-between group">
              <div>
                <div className="flex items-center justify-between mb-2.5 sm:mb-3">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-purple-50/80 border border-purple-100 text-purple-600 flex items-center justify-center shrink-0">
            ...
            <div className="bg-white border border-gray-200/90 rounded-2xl p-3 sm:p-5 lg:p-5 shadow-2xs hover:border-blue-300/80 hover:shadow-xs transition-all duration-200 flex flex-col justify-between group">
              <div>
                <div className="flex items-center justify-between mb-2.5 sm:mb-3">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-sky-50/80 border border-sky-100 text-sky-600 flex items-center justify-center shrink-0">
